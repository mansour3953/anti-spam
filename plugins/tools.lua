...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@TIGER_F59', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'tiger' and not Clang) or (matches[1] == "تایگر" and Clang)) then
...
_Sudoer And Admins tiger Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات تایگر:_
